...
export type MatchSortOption = 'newest' | 'oldest' | 'name_asc' | 'name_desc' | 'rank';
...
const SORT_OPTIONS: { value: MatchSortOption; label: string }[] = [
  { value: 'newest', label: 'Recently Matched' },
    ...
    <View style={styles.container}>
      <View style={styles.topRow}>
        ...
        <View style={styles.headerActions}>
          ...
          <Pressable
            style={[styles.actionButton, count === 0 && { opacity: 0.4 }]}
            onPress={onShare}
            disabled={count === 0}
          >
            <Ionicons name="share-outline" size={16} color="#6B5B7B" />
          </Pressable>
        </View>
      </View>

      <View style={styles.countRow}>
        <Text style={[styles.countText, count === 0 && { opacity: 0 }]}>
