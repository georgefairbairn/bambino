...
- Install, app-open and sign-up events sent to Meta through its SDK, so we can measure our Instagram and Facebook ads. They carry a device identifier and basic device details (like model, OS version and IP address), not your name, email or activity in the App.
...
- We don't use the IDFA (Apple's advertising identifier) or ask to track you across other companies' apps and websites.
...
- To measure our ads: counting the installs and sign-ups they bring in.
- To support you: respond to feedback you submit through the App.

## Who we share data with

Bambino is built on a small set of third-party providers. Your data is shared only with the providers necessary to run and promote the App. Apart from Meta, each acts as a data processor on our behalf:
...
- **Meta** – ad measurement. Receives the install, app-open and sign-up events described above, and uses them under Meta's Business Tools Terms.
...
We don't sell your personal information or share it with data brokers.
...
- **Delete** your account and all associated data — Settings → Delete Account in the App, or contact us
